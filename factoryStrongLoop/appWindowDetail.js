...
function ApplicationWindow(opts) {
	...
	*/
	...
	var self = Ti.UI.createWindow({ title : opts.appData.id, backgroundColor: bgColor });
	...
	//foreach ( var obj in opts.appData.)
	var yackLabel = Ti.UI.createLabel({
		text: opts.appData.name,
		textAlign: 'left',
		font: { fontWeight: 'bold' },
		left: 8, width: 120, height: 40
	});
	topView.add( yackLabel );
