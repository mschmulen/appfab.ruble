...
var uiBarcodeReader = (function() {
	...
	{
		var win = Ti.UI.createWindow({title:'Barcode Reader'});
...
Ti.UI.currentWindow.add( uiBarcodeReader.factoryView({}) );
//uiBarcodeReader.factoryWindow({}).open({modal:true});
//uiBarcodeReader.factoryWindow({}).open({fullscreen:true});
